  ...
  franchiseStores.eachLayer(function (layer) {
    if (map.hasLayer(franchiseStoresLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/favicon.ico"></td><td class="feature-name">' + layer.feature.properties.Chanel + '<br > ' + '<b>' + layer.feature.properties.City + '</b> '+ 
...
/*
var cartoLight = L.tileLayer.provider('MapBox', {
    id: 'streets-v9',
    accessToken: 'pk.eyJ1IjoiZnJhZWxpNzgiLCJhIjoiY2s0OHE1bnJnMDRmNDNrcGJyejdzZXJ5aSJ9.0_Se0Yb1L0VVMss2D7b-yg'
});
*/
...
var franchiseStores = L.geoJSON(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      ...
      +"<div class='block row'><div class='col-xs-10'><strong>"+feature.properties.Business_name+"</strong><br>"+feature.properties.Address+"<br>"+feature.properties.City+"</div>"
      ...
      */
      ...
      +"<div class='block row'><div class='col-xs-10'><div style='display:table-cell;'><img width='24' height='24' src='assets/img/directions.png'>Distance on Google Maps</div></div>"
      ...
      content += "'><div class='col-xs-6'>SAN</div>"
